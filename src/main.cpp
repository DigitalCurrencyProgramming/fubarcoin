...
const string strMessageMagic = "fubarcoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // fubarcoin: 1 days
static const int64 nTargetSpacing = 120; // fubarcoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal fubarcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "fubarcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x7eab1b73d80b49eb1f3b6b3a6927cc3653c68158ec6708029b4a0fec6479e231");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Everything is FUBAR, to coin a phrase.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1451289878; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2472032;

        if (fTestNet)
        {
            block.nTime    = 1451289878;
            block.nNonce   = 2472032;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xe6e811fd15998be52538d573e8b8b470a270cd69933fb7b3907d1d7b1f1cc06e"));
